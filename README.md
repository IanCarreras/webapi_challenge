...
- [ ] Describe Middleware?
    Middlware are functions that are passed request and response objects which can be mutated then either passed to more middlware or the frontend

- [ ] Describe a Resource?
    A resource could be anything; document, photo, etc.  Each resource is identified by a URL

- [ ] What can the API return to help clients know if a request was successful?
    A status code, 200, and a JSON object.    
